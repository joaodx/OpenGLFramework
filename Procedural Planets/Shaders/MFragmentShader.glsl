...
void main(){
    ...
    float turbSize = 20.0; //initial size of the turbulence
	 ...
	 vec4 proceduralMoon = vec4(vec3(0.8-(sineValue*0.1+0.1), 0.8-(sineValue*0.1+0.1), 0.8-(sineValue*0.1+0.1)), 1.0);
	 vec3 fragmentColor = proceduralMoon.xyz;
